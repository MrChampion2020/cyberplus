...
//                     </select>
//                     <div>
//                     <p className='text-primaryColor  text-[12px]'>*(Only admin can access the CyberProff)</p>
//                     </div>
...
const Signup = () => {
  ...
  const validateForm = () => {
    ...
    if (!validatePassword(formData.password)) newErrors.password = 'Password must have at least 8 characters, including one uppercase letter, one lowercase letter, and one number';
