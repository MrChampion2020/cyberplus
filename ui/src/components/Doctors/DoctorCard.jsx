...
const DoctorCard = ({ doctor }) => {
    const { name, avgRating, specialization, experiences, photo, totalRating, _id } = doctor;
    ...
    return (
        <div className="p-3 lg:p-5 mt-2">
            <div>
                <img src={photo} alt={name} className="w-full h-[200px] object-cover rounded-lg" />
            </div>
            <h2 className="text-[18px] leading-[30px] lg:text-[26px] lg:leading-9 text-primaryColor font-[700] mt-3 lg:mt-5">{name}</h2>
            <div className="mt-2 lg:mt-4 flex items-center justify-between">
                <span className='bg-[#ccf0f3] text-primaryColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>{specialization}</span>
                <div className='flex items-center gap-[6px]'>
                    <span className='flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-primaryColor'>
            ...
            <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className='bg-primaryColor text-white px-2 py-2 rounded-full hover:bg-greenColor transition-all duration-300'
                    >
                        Chat
                    </button>
                </div>
